...
# ------------------------
# Creación de usuario nuevo en el archivo "usuarios"
def insertar(userNuevo, contrasNueva):
    with open('usuarios', 'a') as us:
        m1 = csv.writer(us)
        fila = [userNuevo, contrasNueva]
        m1.writerow(fila)
    return flash('El usuario fué agregado con éxito.')
