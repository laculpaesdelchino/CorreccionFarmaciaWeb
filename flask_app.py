...
from forms import LoginForm, ProductoForm, ClienteForm, CrearUsuario
...
def registro():
    ...
    if formulario.validate_on_submit():
        user = formulario.usuarioNuevo.data
        passwd = formulario.passwordNuevo.data
        func_listar.insertar(user, passwd)
